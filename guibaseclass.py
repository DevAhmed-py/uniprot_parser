...
from dbp.widgets.guibaseclass import GuiBaseClass
root=tk.Tk()
...
class GuiBaseClass():
  ...
  def __init__(self,root):
      ...
      command=self._Exit,underline=1)       
      menu_help = tk.Menu(self.menubar)
      self.menubar.add_cascade(menu=menu_help,label='Help',underline=0)
      menu_help.add_command(label='About', command=self._About,underline=0)       
